...
- **Visual system**: unmodified shadcn/ui "New York" blue theme (`src/global.css`), an almost-flat elevation model (visible shadow only on floating surfaces), and a tight 11–15px type scale that carries nearly all hierarchy — see `DESIGN.md` for exact tokens and component specs.
